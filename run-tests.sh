...
# resolves `-b ontology` to <project-root>/build/ontology
...
# No test-data generation or fixtures needed — every testdata/*.jsonl file is checked in.
# ─────────────────────────────────────────────────────────────────────────────
...
# base first, environment config last, since a later file overrides an earlier one.
suite() {
  case "$1/$2" in
